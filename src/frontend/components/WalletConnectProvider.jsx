...
export function WalletConnectProvider({ children }) {
  ...
  const getNetworkConfig = () => {
    const isTestnet = !import.meta.env.VITE_USE_MAINNET || import.meta.env.VITE_USE_MAINNET.toLowerCase() !== 'true';
    return {
      networkUrl: isTestnet 
        ? (import.meta.env.VITE_HORIZON_TESTNET_URL || 'https://horizon-testnet.stellar.org')
        : (import.meta.env.VITE_HORIZON_MAINNET_URL || 'https://horizon.stellar.org'),
